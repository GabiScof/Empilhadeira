...
Converte detecções com pose 6DoF para z_cm, x_cm e pitch_deg do contrato.
Pitch de tag única tem ambiguidade conhecida; offset câmera→garfo via config.
"""
...
def estimate_tag_observations(detections: list[Any]) -> list[TagObservation]:
    ...
    TODO(equipe): validar convenção de yaw no hardware real.
    """
