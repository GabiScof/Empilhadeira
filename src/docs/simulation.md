...
Entrada: `main.py`, `pi/app/sim/`, `config.py`.
...
O emulador de firmware (`firmware_emulator.py`) replica:
...
- Garfo com duty fixo 220 (subiu de 180 na bancada para levantar com carga) e limites topo/base
...
Ver [`simulator-to-real.md`](./simulator-to-real.md) — o que o sim validou vs o que
muda no hardware. Resumo operacional: [`hardware-deployment.md`](./hardware-deployment.md).
